...
RUST_LOG=debug timeout 5 cargo run -p codex-cli-acp --bin codex-cli-acp 2>test_debug.log < _artifacts/tests/protocol-baseline/session_update_format.jsonl > test_output.jsonl || true
