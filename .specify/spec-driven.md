About: Specification-Driven Development (SDD) documentation
...
- .specify/memory-template/constitution.md
- .specify/memory-template/constitution_update_checklist.md
- .specify/templates/spec-template.md
- .specify/templates/plan-template.md
- .specify/templates/tasks-template.md
- .specify/commands-template/specify.md
- .specify/commands-template/plan.md
- .specify/commands-template/tasks.md
