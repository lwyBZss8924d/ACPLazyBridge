...
allowed-tools: Bash(scripts/sdd/check-task-prerequisites.sh:*), Read, Write, Edit, Glob, Grep
---
...
// ⚠️ _Whether initializing, modifying, or updating this SDD TASKs file (specs/xxxx-xxxx/plan.md), YOU MUST ULTRATHINK Analyze ISSUES [input], spec.md and plan.md then edit the template file for the task first!_
