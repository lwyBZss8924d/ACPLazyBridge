# AGENTS.md (Authoritative) — SDD Developer Team's AI Engineers

This document defines the roles, responsibilities, and coordination model for AI Engineers ("agents") working within our Specification‑Driven Development (SDD) team. It follows the SDD principles in spec-driven.md: specifications are the primary artifacts; plans and code serve the spec. and AI Engineers development rules for human engineers and AI coding agents (Claude Code, WARP, Gemini, Codex, etc.). It complements CONTRIBUTING.md and sdd-rules/lifecycle.md.

> Convention note: We align to the community `agents.md` pattern to describe supported agents and their configurations for SDD workflows.
